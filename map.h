...
#define LADDER    2
#define NPC       3
#define BREAKABLEWALL 4
#define SONAR     5
#define TREASURE  6
#define SNAKE     7
#define TREE      8
#define FAKE_TREASURE 9
...
/**
 * Add a ladder with the target map and target position of player
 */
void add_ladder(int x, int y, int target_map, int target_x, int target_y);

#define WISE_BEAR 0
#define MASTER_SQUIRREL 1
#define NPC_SQUIRREL1 3
#define NPC_SQUIRREL2 4
#define NPC_SQUIRREL3 5
